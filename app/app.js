...
//var GETH_HOSTNAME	= "167.114.100.39" ;	// put your IP address!
//var APP_HOSTNAME 	= "167.114.100.39"; // See package.json --> scripts --> start: Change 'localhost'!!!";
var GETH_HOSTNAME	= "localhost" ;
var APP_HOSTNAME 	= "localhost";

//var GETH_RPCPORT  	= "8548"; 		// for geth --rpcport GETH_RPCPORT
//var APP_PORT 		= "80"; //See package.json --> scripts --> start: Perhaps change '8000'";
...
angular.module('ethExplorer', ['ngRoute','ui.bootstrap','filters','ngSanitize','ngTable'])
...
/*
    ...
    .run(function($rootScope) {
		...
		var addressContract = '0x4df1ecbc0bdcce4a47306321bbe81b731aefe60c';
